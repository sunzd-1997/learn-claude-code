...
SUBAGENT_SYSTEM_PROMPT = f"""You are a coding subagent at {WORKDIR}. Complete the given task, then summarize your findings."""
...
def run_subagent(prompt: str) -> str:
    ...
    for _ in range(30):
        response_data = call_open_api(sub_messages, CHILD_TOOLS)
        ...
        if choice["finish_reason"] != "tool_calls":
            return message.get("content") or "(no summary)"
    ...
    return "Error: Subagent exceeded max tool rounds"
